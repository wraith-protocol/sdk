...
describe("meta-address", () => {
  ...
  test("rejects invalid prefix", () => {
    expect(() => decodeStealthMetaAddress("st:eth:0x" + "aa".repeat(64))).toThrow("Invalid stealth meta-address prefix");
  });

  test("rejects wrong length", () => {
    expect(() => decodeStealthMetaAddress("st:xlm:" + "aa".repeat(60))).toThrow("Invalid stealth meta-address length");
  });
