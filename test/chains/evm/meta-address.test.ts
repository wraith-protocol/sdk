...
describe("meta-address", () => {
  ...
  test("rejects invalid prefix", () => {
    expect(() => decodeStealthMetaAddress("st:xlm:0x" + "aa".repeat(66))).toThrow("Invalid stealth meta-address prefix");
  });

  test("rejects wrong length", () => {
    expect(() => decodeStealthMetaAddress("st:eth:0x" + "aa".repeat(60))).toThrow("Invalid stealth meta-address length");
  });
